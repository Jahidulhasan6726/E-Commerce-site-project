...
namespace work_sessions.Controllers
{
    public class AppUsersController : Controller
    {
        ...
        public AppUsersController(ShopDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AppUsers != null ? 
                          ...
                          Problem("Entity set 'ShopDbContext.AppUsers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopDbContext.AppUsers'  is null.");
            }
            var appUser = await _context.AppUsers.FindAsync(id);
            if (appUser != null)
            {
